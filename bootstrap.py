...
# Noweb tags and tangle tags must appear on lines by themselves,
# left-justified.
...
# Block tags appear anywhere on a line (a little surprising that I needed the
# '.*').
...
print r"#  _  _  _____      _____ ___   ___ _    ___   ___ _  _____"
print r"# | \| |/ _ \ \    / / __| _ ) | _ ) |  / _ \ / __| |/ / __|"
print r"# | .` | (_) \ \/\/ /| _|| _ \ | _ \ |_| (_) | (__| ' <\__ \ "
print r"# |_|\_|\___/ \_/\_/ |___|___/ |___/____\___/ \___|_|\_\___/"

print ('NOWEB BLOCKS')
pprint.pprint (noweb_blocks)

print r"#  _____ _   _  _  ___ _    ___   ___ _    ___   ___ _  _____"
print r"# |_   _/_\ | \| |/ __| |  | __| | _ ) |  / _ \ / __| |/ / __|"
print r"#   | |/ _ \| .` | (_ | |__| _|  | _ \ |_| (_) | (__| ' <\__ \ "
print r"#   |_/_/ \_\_|\_|\___|____|___| |___/____\___/ \___|_|\_\___/"

print ('TANGLE FILES')
pprint.pprint (tangle_files)
